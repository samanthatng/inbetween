...
export default function Home() {
  ...
  function copyLink() {
    const url = `https://inbetween.sg/r/${postalA}/${category}`;
    ...
    <>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .share-url { font-size: 12px; background: rgba(255,255,255,0.08); border-radius: 6px; padding: 5px 10px; color: var(--sage); font-family: monospace; margin-top: 6px; display: inline-block; }
        ...
        <div className="results-section fade-up" id="results-section">
          ...
          <div className="share-strip">
            <div className="share-left">
              ...
              <p>They'll see the same spots — no back and forth</p>
              <div className="share-url">inbetween.sg/r/{postalA}/{category}</div>
            </div>
